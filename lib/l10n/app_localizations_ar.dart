...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get downloadsTitle => 'المرحلة 4: تنزيل Foreground Service';
  ...
  @override
  String get pdfReady =>
      'ملف PDF جاهز. اضغط تنزيل لتشغيله عبر Foreground Service مع تتبع التقدم.';

  @override
  String downloadingPdf(int progress) {
    return 'تنزيل Foreground... $progress%';
  }
